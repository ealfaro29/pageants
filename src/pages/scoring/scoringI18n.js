...
export const scoringCopy = {
  es: {
    ...
    board: {
      ...
      bulkAddButton: 'Agregar desde lista',
      bulkAddShort: 'Lista',
      bulkAddTitle: 'Pegar lista para limpieza',
      bulkAddHelp: 'Pega el texto tal como venga. Se detectarán país/ciudad por línea y verás una previa antes de agregar.',
      bulkAddPlaceholderGlobal: 'Ejemplo: 1. PHILIPPINES 🇵🇭 - Mara Ana - CE #1',
      bulkAddPlaceholderNational: 'Ejemplo: 1. San José - UsuarioX - CE #1',
      bulkAddPreviewButton: 'Generar previa',
      bulkAddApply: count => `Agregar ${count}`,
      bulkAddApplying: 'Agregando...',
      bulkAddClear: 'Limpiar',
      bulkAddClose: 'Cerrar',
      bulkAddPreviewSummary: (parsed, total, skipped) => `Previa: ${parsed}/${total} válidas${skipped > 0 ? ` · ${skipped} omitidas` : ''}.`,
      bulkAddSkippedTitle: 'Líneas omitidas',
      bulkAddSkippedLine: line => `Línea ${line}`,
      bulkAddReviewSkipped: count => `Revisar ${count}`,
      bulkAddSkippedModalTitle: 'Revisar líneas omitidas',
      bulkAddSkippedModalHelp: 'Edita cada línea, bórrala si no aplica o envíala tal cual para agregarla manualmente a la previa.',
      bulkAddSkippedEmpty: 'No hay líneas pendientes para revisar.',
      bulkAddRemoveLine: 'Borrar',
      bulkAddCancelReview: 'Cerrar revisión',
      bulkAddSubmitAsIs: 'Enviar tal cual',
      ...
      submitScores: 'Enviar puntajes',
      resubmitScores: 'Reenviar puntajes',
      submitScoresBusy: 'Enviando...',
      submitScoresStatusSubmitted: 'Puntajes enviados',
      submitScoresStatusDraft: 'Cambios sin enviar',
      submitScoresIncomplete: missing => `Faltan ${missing} puntajes por completar antes de enviar.`,
      submitScoresError: 'No se pudieron enviar los puntajes. Intenta de nuevo.',
      pendingSubmitList: names => `Falta submit de: ${names}`,
      advancingPhaseBusy: 'Procesando fase...',
      ...
      undoPhaseWarning: 'Esto conserva los resultados publicados y vuelve a la fase anterior.',
      ...
      aggregateRankingsTitle: 'Clasificación General',
      aggregateRankingsSubtitle: 'Resultados acumulados de todas las fases',
      lastPhaseResultsTitle: 'Última Fase Completada',
      lastPhaseResultsSubtitle: 'Clasificados y eliminados de la última fase',
      ...
      runnerUpsTitle: 'Finalistas destacadas',
      firstRunnerUpLabel: '1st RU',
      secondRunnerUpLabel: '2nd RU',
  ...
  en: {
    ...
    board: {
      ...
      bulkAddButton: 'Add from list',
      bulkAddShort: 'List',
      bulkAddTitle: 'Paste list to clean',
      bulkAddHelp: 'Paste raw text as-is. Country/city is detected per line, and you get a preview before adding.',
      bulkAddPlaceholderGlobal: 'Example: 1. PHILIPPINES 🇵🇭 - Mara Ana - CE #1',
      bulkAddPlaceholderNational: 'Example: 1. San José - UserX - CE #1',
      bulkAddPreviewButton: 'Generate preview',
      bulkAddApply: count => `Add ${count}`,
      bulkAddApplying: 'Adding...',
      bulkAddClear: 'Clear',
      bulkAddClose: 'Close',
      bulkAddPreviewSummary: (parsed, total, skipped) => `Preview: ${parsed}/${total} valid${skipped > 0 ? ` · ${skipped} skipped` : ''}.`,
      bulkAddSkippedTitle: 'Skipped lines',
      bulkAddSkippedLine: line => `Line ${line}`,
      bulkAddReviewSkipped: count => `Review ${count}`,
      bulkAddSkippedModalTitle: 'Review skipped lines',
      bulkAddSkippedModalHelp: 'Edit each line, remove it if needed, or submit it as-is to add it manually to preview.',
      bulkAddSkippedEmpty: 'There are no pending lines to review.',
      bulkAddRemoveLine: 'Remove',
      bulkAddCancelReview: 'Close review',
      bulkAddSubmitAsIs: 'Submit as-is',
      ...
      resubmitScores: 'Resubmit scores',
      submitScoresBusy: 'Submitting...',
      submitScoresStatusSubmitted: 'Scores submitted',
      submitScoresStatusDraft: 'Draft changes not submitted',
      submitScoresIncomplete: missing => `${missing} scores are still missing before submit.`,
      submitScoresError: 'Unable to submit scores. Please try again.',
      pendingSubmitList: names => `Pending submit from: ${names}`,
      advancingPhaseBusy: 'Processing phase...',
      ...
      undoPhaseWarning: 'This keeps published results and returns to the previous phase.',
      ...
      aggregateRankingsTitle: 'General Rankings',
      aggregateRankingsSubtitle: 'Accumulated results across all phases',
      lastPhaseResultsTitle: 'Last Completed Phase',
      lastPhaseResultsSubtitle: 'Qualified and eliminated from the last phase',
      ...
      runnerUpsTitle: 'Featured finalists',
      firstRunnerUpLabel: '1st RU',
      secondRunnerUpLabel: '2nd RU',
