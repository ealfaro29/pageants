...
export function getCountries(language = 'es') {
  ...
  return REGION_CODES
    .map(regionCode => ({
      name: localizedNames.of(regionCode) || englishNames.of(regionCode) || regionCode,
      apiName: englishNames.of(regionCode) || regionCode,
